            ...
            <div className="flex flex-col justify-center items-start gap-y-[50px] col-span-3">
              ...
              <div className="flex justify-center items-center">
                <Swiper modules={[Pagination, Autoplay, Navigation]} 
                  ...
                  className="mySwiper max-w-[400px]">
                  <SwiperSlide>
                    <img src="/hero1.jpeg" alt="Hero Image" className="border-[10px] mx-auto w-[300px] h-[391px] sm:w-[400px] sm:h-[522px] object-cover rounded-[100px] rounded-es-none" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img src="/hero2.jpeg" alt="Hero Image" className="border-[10px] mx-auto w-[300px] h-[391px] sm:w-[400px] sm:h-[522px] object-cover rounded-[100px] rounded-es-none" />
                  </SwiperSlide>
                </Swiper>
              </div>
          </div>
