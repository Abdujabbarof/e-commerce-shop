...
const Locations = () => {
  return (
    <section className="py-[50px]" id="contacts">
        <div className="main_container flex flex-col gap-[40px] justify-start items-center">
            <motion.h1 {...slideAnimation("left")} className="leading-[130%] text-center w-full text-[34px] sm:text-[40px] font-bold">Kontaktlar</motion.h1>
            ...
            <div className="w-full border py-[20px] px-[20px] grid md:grid-cols-2 gap-3">
                ...
                <div >
                    <motion.iframe {...fadeAnimation} className="w-full h-[300px] md:h-[440px]" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2996.517377620516!2d69.227675225946!3d41.319361700212134!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae8b99b2c2aeb3%3A0x76bfac859c7018a0!2sChorsu%2C%20%D0%A2%D0%BEshkent%2C%20Toshkent%20Viloyati%2C%20O%60zbekiston!5e0!3m2!1suz!2s!4v1706350551686!5m2!1suz!2s" allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></motion.iframe>
                </div>
            </div>
        </div>
    </section>
